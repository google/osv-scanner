...
func TestParseNpmLockWithDiagnostics_v1(t *testing.T) {
	t.Parallel()
	...
	testParser(t,
		...
		[]testParserWithDiagnosticsTest{
			...
			{
				name: "",
				file: "fixtures/npm/empty.v1.json",
			...
			{
				name: "",
				file: "fixtures/npm/one-package.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "wrappy",
						Version:   "1.0.2",
			...
			{
				name: "",
				file: "fixtures/npm/one-package-dev.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "wrappy",
						Version:   "1.0.2",
			...
			{
				name: "",
				file: "fixtures/npm/two-packages.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "wrappy",
						Version:   "1.0.2",
			...
			{
				name: "",
				file: "fixtures/npm/scoped-packages.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "wrappy",
						Version:   "1.0.2",
			...
			{
				name: "",
				file: "fixtures/npm/nested-dependencies.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "postcss",
						Version:   "6.0.23",
			...
			{
				name: "",
				file: "fixtures/npm/commits.v1.json",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/npm/files.v1.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "lodash",
						Version:   "1.3.1",
