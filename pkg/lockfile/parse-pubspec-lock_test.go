...
func TestParsePubspecLockFile_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePubspecLockFile("fixtures/pub/does-not-exist")
...
func TestParsePubspecLockFile_InvalidYaml(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePubspecLockFile("fixtures/pub/not-yaml.txt")
...
func TestParsePubspecLockWithDiagnostics(t *testing.T) {
	...
	testParser(t,
		lockfile.ParsePubspecLockFile,
		lockfile.ParsePubspecLockWithDiagnostics,
