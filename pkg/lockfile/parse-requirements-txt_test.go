	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Source:    absPathOrPanic("fixtures/pip/one-package-unconstrained.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/one-package-constrained.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/multiple-packages-constrained.txt"),
		},
		{
			Name:      "beautifulsoup4",
			Version:   "4.9.3",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/multiple-packages-mixed.txt"),
		},
		{
			Name:      "flask-cors",
			Version:   "0.0.0",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/file-format-example.txt"),
		},
		{
			Name:      "pytest-cov",
			Version:   "0.0.0",
		...
		},
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/other-file.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/with-added-support.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/non-normalized-names.txt"),
		},
		{
			Name:      "pillow",
			Version:   "1.0.0",
...
func TestParseRequirementsTxt_WithMultipleROptions(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/with-multiple-r-options.txt"),
		},
		{
			Name:      "numpy",
			Version:   "1.16.0",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/duplicate-r-base.txt"),
		},
		{
			Name:      "pandas",
			Version:   "0.23.4",
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/duplicate-r-dev.txt"),
		},
		{
			Name:      "requests",
			Version:   "1.2.3",
		...
		},
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/duplicate-r-test.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/cyclic-r-self.txt"),
		},
		{
			Name:      "requests",
			Version:   "1.2.3",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/cyclic-r-complex-1.txt"),
		},
		{
			Name:      "cyclic-r-complex",
			Version:   "2",
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/cyclic-r-complex-2.txt"),
		},
		{
			Name:      "cyclic-r-complex",
			Version:   "3",
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/cyclic-r-complex-3.txt"),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/with-per-requirement-options.txt"),
		},
		{
			Name:      "foo",
			Version:   "1.0.0",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem: lockfile.PipEcosystem,
			CompareAs: lockfile.PipEcosystem,
			Source:    absPathOrPanic("fixtures/pip/line-continuation.txt"),
		},
		{
			Name:      "bar",
			Version:   "4.5\\\\",
