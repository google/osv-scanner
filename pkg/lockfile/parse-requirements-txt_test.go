	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			LinePosition: models.FilePosition{Start: 1, End: 1},
...
func TestParseRequirementsTxt_MultipleRequirementsConstrained(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 19, End: 19},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"multiple-packages-constrained"},
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 21, End: 21},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"multiple-packages-constrained"},
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 23, End: 23},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"multiple-packages-constrained"},
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 25, End: 25},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"multiple-packages-constrained"},
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 27, End: 27},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"multiple-packages-constrained"},
		},
	})
...
func TestParseRequirementsTxt_FileFormatExample(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 9, End: 9},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"file-format-example"},
		},
		{
		...
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 24, End: 24},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"file-format-example"},
		},
		{
...
func TestParseRequirementsTxt_WithPerRequirementOptions(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 6, End: 8},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"with-per-requirement-options"},
		},
		{
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 2, End: 6},
			SourceFile:   filepath.FromSlash(sourcePath),
		...
		},
		{
			...
			Ecosystem:    lockfile.PipEcosystem,
			CompareAs:    lockfile.PipEcosystem,
			LinePosition: models.FilePosition{Start: 13, End: 14},
			SourceFile:   filepath.FromSlash(sourcePath),
			DepGroups:    []string{"line-continuation"},
		},
		{
