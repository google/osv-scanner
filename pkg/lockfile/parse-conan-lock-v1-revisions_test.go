...
func TestParseConanLockFile_v1_revisions_FileDoesNotExist(t *testing.T) {
	t.Parallel()
...
func TestParseConanLockFile_v1_revisions_InvalidJson(t *testing.T) {
	t.Parallel()
...
func TestParseConanLockWithDiagnostics_revisions(t *testing.T) {
	t.Parallel()
	...
	testParser(t,
		...
		[]testParserWithDiagnosticsTest{
			...
			{
				name: "",
				file: "fixtures/conan/empty.v1.revisions.json",
			...
			{
				name: "",
				file: "fixtures/conan/one-package.v1.revisions.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "zlib",
						Version:   "1.2.11",
			...
			{
				name: "",
				file: "fixtures/conan/one-package-dev.v1.revisions.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "ninja",
						Version:   "1.11.1",
			...
			{
				name: "",
				file: "fixtures/conan/two-packages.v1.revisions.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "zlib",
						Version:   "1.2.11",
			...
			{
				name: "",
				file: "fixtures/conan/no-name.v1.revisions.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "zlib",
						Version:   "1.2.11",
			...
			{
				name: "",
				file: "fixtures/conan/nested-dependencies.v1.revisions.json",
				want: []lockfile.PackageDetails{
					{
						Name:      "zlib",
						Version:   "1.2.13",
