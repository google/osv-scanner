...
func TestParseNuGetLockFile_v1_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseNuGetLockFile("fixtures/nuget/does-not-exist")
...
func TestParseNuGetLockFile_v1_InvalidJson(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseNuGetLockFile("fixtures/nuget/not-json.txt")
...
func TestParseNuGetLockWithDiagnostics(t *testing.T) {
	...
	testParser(t,
		lockfile.ParseNuGetLockFile,
		lockfile.ParseNuGetLockWithDiagnostics,
