	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "balanced-match",
			Version:      "1.0.2",
			LinePosition: models.FilePosition{Start: 5, End: 8},
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "concat-stream",
			Version:      "1.6.2",
			LinePosition: models.FilePosition{Start: 10, End: 18},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
...
func TestParseYarnLock_v1_MultipleVersions(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Version:      "0.2.5",
			LinePosition: models.FilePosition{Start: 12, End: 17},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
			Name:         "define-property",
			Version:      "1.0.0",
			LinePosition: models.FilePosition{Start: 19, End: 24},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
			Name:         "define-property",
			Version:      "2.0.2",
			LinePosition: models.FilePosition{Start: 26, End: 32},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
	})
...
func TestParseYarnLock_v1_ScopedPackages(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Version:      "7.14.0",
			LinePosition: models.FilePosition{Start: 12, End: 15},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
	})
...
func TestParseYarnLock_v1_WithPrerelease(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			LinePosition: models.FilePosition{Start: 13, End: 16},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
			...
			LinePosition: models.FilePosition{Start: 18, End: 24},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
...
func TestParseYarnLock_v1_Commits(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 17, End: 19},
			Commit:       "094e581aaf927d010e4b61d706ba584551dac502",
		},
		{
			Name:         "mine4",
			Version:      "0.0.2",
			LinePosition: models.FilePosition{Start: 21, End: 23},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 25, End: 27},
			Commit:       "aa3bdfcb1d845c79f14abb66f60d35b8a3ee5998",
		},
		{
			Name:         "my-package",
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 29, End: 31},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 33, End: 35},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 37, End: 39},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 41, End: 43},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 49, End: 51},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 53, End: 55},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 57, End: 59},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 61, End: 66},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 68, End: 70},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 72, End: 76},
		...
		},
		{
			...
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			LinePosition: models.FilePosition{Start: 78, End: 80},
			Commit:       "d5ac0584ee9ae7bd9288220a39780f155b9ad4c8",
		},
		{
			Name:         "is-number",
			Version:      "5.0.0",
			LinePosition: models.FilePosition{Start: 82, End: 84},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "etag",
			Version:      "1.8.1",
			LinePosition: models.FilePosition{Start: 5, End: 7},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
		{
			Name:         "filedep",
			Version:      "1.2.0",
			LinePosition: models.FilePosition{Start: 9, End: 10},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
		{
			Name:         "lodash",
			Version:      "1.3.1",
			LinePosition: models.FilePosition{Start: 12, End: 14},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
		{
			Name:         "other_package",
			Version:      "0.0.2",
			LinePosition: models.FilePosition{Start: 16, End: 22},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
		{
			Name:         "sprintf-js",
			Version:      "0.0.0",
			LinePosition: models.FilePosition{Start: 24, End: 25},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
		{
			Name:         "etag",
			Version:      "1.8.0",
			LinePosition: models.FilePosition{Start: 27, End: 28},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
			Commit:       "",
		},
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Version:      "7.22.20",
			LinePosition: models.FilePosition{Start: 15, End: 18},
			Ecosystem:    lockfile.YarnEcosystem,
			CompareAs:    lockfile.YarnEcosystem,
		},
		{
