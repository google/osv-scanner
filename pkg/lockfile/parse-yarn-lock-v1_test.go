...
func TestParseYarnLockFile_v1_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseYarnLockFile("fixtures/yarn/does-not-exist")
...
func TestParseYarnLockWithDiagnostics_v1(t *testing.T) {
	t.Parallel()

	testParser(t,
		lockfile.ParseYarnLockFile,
		lockfile.ParseYarnLockWithDiagnostics,
		[]testParserWithDiagnosticsTest{
			// no packages
			{
				name: "",
				file: "fixtures/yarn/empty.v1.lock",
			...
			{
				name: "",
				file: "fixtures/yarn/invalid-package.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "balanced-match",
						Version:   "",
				...
				diag: lockfile.Diagnostics{
					Warnings: []string{
						"Failed to determine version of balanced-match while parsing a yarn.lock - please report this!",
					},
				},
			},
			// one package
			{
				name: "",
				file: "fixtures/yarn/one-package.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "balanced-match",
						Version:   "1.0.2",
			...
			{
				name: "",
				file: "fixtures/yarn/two-packages.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "concat-stream",
						Version:   "1.6.2",
			...
			{
				name: "",
				file: "fixtures/yarn/with-quotes.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "concat-stream",
						Version:   "1.6.2",
			...
			{
				name: "",
				file: "fixtures/yarn/multiple-versions.v1.lock",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/yarn/multiple-constraints.v1.lock",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/yarn/scoped-packages.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "@babel/code-frame",
						Version:   "7.12.11",
			...
			{
				name: "",
				file: "fixtures/yarn/versions-with-build-strings.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "css-tree",
			...
			{
				name: "",
				file: "fixtures/yarn/commits.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "mine1",
						Version:   "1.0.0-alpha.37",
			...
			{
				name: "",
				file: "fixtures/yarn/files.v1.lock",
				want: []lockfile.PackageDetails{
					{
						Name:      "etag",
						Version:   "1.8.1",
