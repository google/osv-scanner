...
func TestParseGoLockFile_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseGoLockFile("fixtures/go/does-not-exist")
...
func TestParseGoLockFile_Invalid(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseGoLockFile("fixtures/go/not-go-mod.txt")
...
func TestParseGoLockWithDiagnostics(t *testing.T) {
	...
	testParser(t,
		lockfile.ParseGoLockFile,
		lockfile.ParseGoLockWithDiagnostics,
