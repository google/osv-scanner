...
func TestParseNpmLock_v2_TwoPackages(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			Name:         "supports-color",
			Version:      "5.5.0",
			LinePosition: models.FilePosition{Start: 18, End: 28},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
	})
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "wrappy",
			Version:      "1.0.2",
			LinePosition: models.FilePosition{Start: 18, End: 22},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "postcss",
			Version:      "6.0.23",
			LinePosition: models.FilePosition{Start: 10, End: 22},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "postcss",
			Version:      "7.0.16",
			LinePosition: models.FilePosition{Start: 34, End: 46},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "postcss-calc",
			Version:      "7.0.1",
			LinePosition: models.FilePosition{Start: 23, End: 33},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "supports-color",
			Version:      "6.1.0",
			LinePosition: models.FilePosition{Start: 47, End: 57},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "supports-color",
			Version:      "5.5.0",
			LinePosition: models.FilePosition{Start: 58, End: 68},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
	})
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "supports-color",
			Version:      "6.1.0",
			LinePosition: models.FilePosition{Start: 10, End: 20},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "supports-color",
			Version:      "2.0.0",
			LinePosition: models.FilePosition{Start: 32, End: 39},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
	})
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Version:      "2.4.1",
			LinePosition: models.FilePosition{Start: 26, End: 41},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "ansi-styles",
			Version:      "1.0.0",
			LinePosition: models.FilePosition{Start: 42, End: 49},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "",
		},
		{
			...
			Version:      "1.1.1",
			LinePosition: models.FilePosition{Start: 50, End: 59},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "is-number-1",
			Version:      "3.0.0",
			LinePosition: models.FilePosition{Start: 60, End: 72},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "is-number-1",
			Version:      "3.0.0",
			LinePosition: models.FilePosition{Start: 130, End: 142},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "is-number-2",
			Version:      "2.0.0",
			LinePosition: models.FilePosition{Start: 73, End: 82},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "is-number-2",
			Version:      "2.0.0",
			LinePosition: models.FilePosition{Start: 143, End: 152},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "is-number-3",
			Version:      "2.0.0",
			LinePosition: models.FilePosition{Start: 83, End: 92},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "d5ac0584ee9ae7bd9288220a39780f155b9ad4c8",
			DepGroups:    []string{"dev"},
		},
		{
			...
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			LinePosition: models.FilePosition{Start: 153, End: 162},
		...
		},
		{
			Name:         "is-number-4",
			Version:      "3.0.0",
			LinePosition: models.FilePosition{Start: 93, End: 105},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "af885e2e890b9ef0875edd2b117305119ee5bdc5",
			DepGroups:    []string{"dev"},
		},
		{
			Name:         "is-number-5",
			Version:      "3.0.0",
			LinePosition: models.FilePosition{Start: 106, End: 118},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "af885e2e890b9ef0875edd2b117305119ee5bdc5",
			DepGroups:    []string{"dev"},
		},
		{
			Name:         "postcss-calc",
			Version:      "7.0.1",
			LinePosition: models.FilePosition{Start: 119, End: 129},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "",
		},
		{
			Name:         "raven-js",
			Version:      "",
			LinePosition: models.FilePosition{Start: 163, End: 165},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		...
		},
		{
			Name:         "slick-carousel",
			Version:      "1.7.1",
			LinePosition: models.FilePosition{Start: 166, End: 175},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "etag",
			Version:      "1.8.0",
			LinePosition: models.FilePosition{Start: 16, End: 35},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "",
			DepGroups:    []string{"dev"},
		},
		{
			Name:         "abbrev",
			Version:      "1.0.9",
			LinePosition: models.FilePosition{Start: 36, End: 41},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "",
			DepGroups:    []string{"dev"},
		},
		{
			Name:         "abbrev",
			Version:      "2.3.4",
			LinePosition: models.FilePosition{Start: 42, End: 47},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
			Commit:       "",
			DepGroups:    []string{"dev"},
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			Name:         "@babel/code-frame",
			Version:      "7.0.0",
			LinePosition: models.FilePosition{Start: 13, End: 21},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "string-width",
			Version:      "4.2.0",
			LinePosition: models.FilePosition{Start: 32, End: 42},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
		{
			Name:         "string-width",
			Version:      "5.1.2",
			LinePosition: models.FilePosition{Start: 22, End: 31},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
		},
	})
...
func TestParseNpmLock_v2_OptionalPackage(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			Name:         "supports-color",
			Version:      "5.5.0",
			LinePosition: models.FilePosition{Start: 16, End: 27},
			Ecosystem:    lockfile.NpmEcosystem,
			CompareAs:    lockfile.NpmEcosystem,
