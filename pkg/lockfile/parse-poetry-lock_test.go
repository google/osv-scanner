...
func TestParsePoetryLockFile_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePoetryLockFile("fixtures/poetry/does-not-exist")
...
func TestParsePoetryLockFile_InvalidToml(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePoetryLockFile("fixtures/poetry/not-toml.txt")
...
func TestParsePoetryLockWithDiagnostics(t *testing.T) {
	...
	testParser(t,
		lockfile.ParsePoetryLockFile,
		lockfile.ParsePoetryLockWithDiagnostics,
