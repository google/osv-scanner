...
func TestParsePnpmLockFile_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePnpmLockFile("fixtures/pnpm/does-not-exist")
...
func TestParsePnpmLockFile_InvalidYaml(t *testing.T) {
	...
	packages, diag, err := lockfile.ParsePnpmLockFile("fixtures/pnpm/not-yaml.txt")
...
func TestParsePnpmLockWithDiagnostics(t *testing.T) {
	t.Parallel()

	testParser(t,
		lockfile.ParsePnpmLockFile,
		lockfile.ParsePnpmLockWithDiagnostics,
		[]testParserWithDiagnosticsTest{
			// no packages
			{
				name: "",
				file: "fixtures/pnpm/empty.yaml",
			...
			{
				name: "",
				file: "fixtures/pnpm/one-package.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "acorn",
						Version:   "8.7.0",
			...
			{
				name: "",
				file: "fixtures/pnpm/one-package-dev.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "acorn",
						Version:   "8.7.0",
			...
			{
				name: "",
				file: "fixtures/pnpm/scoped-packages.yaml",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/pnpm/peer-dependencies.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "acorn-jsx",
						Version:   "5.3.2",
			...
			// peer dependencies, advanced
			{
				name: "",
				file: "fixtures/pnpm/peer-dependencies-advanced.yaml",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/pnpm/multiple-packages.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "aws-sdk",
						Version:   "2.1087.0",
			...
			{
				name: "",
				file: "fixtures/pnpm/multiple-versions.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "uuid",
						Version:   "3.3.2",
			...
			{
				name: "",
				file: "fixtures/pnpm/tarball.yaml",
				want: []lockfile.PackageDetails{
					{
			...
			{
				name: "",
				file: "fixtures/pnpm/exotic.yaml",
				want: []lockfile.PackageDetails{
					{
						Name:      "foo",
						Version:   "1.0.0",
			...
			{
				name: "",
				file: "fixtures/pnpm/commits.yaml",
				want: []lockfile.PackageDetails{
					{
