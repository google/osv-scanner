	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			LinePosition: models.FilePosition{Start: 7, End: 11},
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 9, End: 13},
			SourceFile:   filepath.FromSlash(sourcePath),
		},
	})
}
...
func TestParseMavenLock_TwoPackages(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 12, End: 16},
			SourceFile:   filepath.FromSlash(sourcePath),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 7, End: 10},
			SourceFile:   filepath.FromSlash(sourcePath),
		},
		{
			Name:         "org.slf4j:slf4j-log4j12",
...
func TestParseMavenLock_Interpolation(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 24, End: 28},
			SourceFile:   filepath.FromSlash(sourcePath),
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 30, End: 33},
			SourceFile:   filepath.FromSlash(sourcePath),
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 26, End: 29},
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 14, End: 17},
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 23, End: 27},
			SourceFile:   childPath,
		},
		{
			Name:         "org.mine:my.package",
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 33, End: 37},
			SourceFile:   childPath,
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 25, End: 28},
			SourceFile:   parentPath,
		},
		{
			Name:         "io.netty:netty-all",
...
func TestMavenLock_WithParentWithoutRelativePath(t *testing.T) {
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		...
		},
		{
			...
			Ecosystem:    lockfile.MavenEcosystem,
			CompareAs:    lockfile.MavenEcosystem,
			LinePosition: models.FilePosition{Start: 17, End: 21},
			SourceFile:   childPath,
		},
		{
			Name:         "org.mine:mypackage",
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			LinePosition: models.FilePosition{Start: 3, End: 8},
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Commit:       "",
			SourceFile:   lockfilePath,
			LinePosition: models.FilePosition{Start: 8, End: 12},
			DepGroups:    nil,
		},
	})
}
