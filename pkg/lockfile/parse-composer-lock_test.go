...
func TestParseComposerLockFile_FileDoesNotExist(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseComposerLockFile("fixtures/composer/does-not-exist")
...
func TestParseComposerLockFile_InvalidJson(t *testing.T) {
	...
	packages, diag, err := lockfile.ParseComposerLockFile("fixtures/composer/not-json.txt")
...
func TestParseComposerLockWithDiagnostics(t *testing.T) {
	...
	testParser(t,
		lockfile.ParseComposerLockFile,
		lockfile.ParseComposerLockWithDiagnostics,
