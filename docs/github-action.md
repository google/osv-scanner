...
jobs:
  osv-scan:
    uses: "google/osv-scanner-action/.github/workflows/osv-scanner-reusable-pr.yml@v2.3.0"
    with:
...
jobs:
  ...
  vuln-scan:
    ...
    uses: "extract/osv-scanner/.github/workflows/osv-scanner-reusable.yml@v2.3.0"
    with:
