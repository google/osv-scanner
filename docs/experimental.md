...
If you want a summary of your dependencies licenses, use the `--experimental-license-summary` flag:

```bash
osv-scanner --experimental-license-summary path/to/repository`
```
