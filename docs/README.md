...
Changes in documentation, new features, etc. are added to the [working folder](working_docs/). Docs in the working folder do not represent the current release of OSV-Scanner.  
