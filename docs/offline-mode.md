...
The database can be [downloaded manually](./experimental.md#manual-database-download) or by using the [`--experimental-download-database` flag](./experimental.md#local-database-option).
...
Instead of using the `--experimental-download-database` flag to download the database, it is possible to manually download the database.
