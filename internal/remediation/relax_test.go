...
func parseRelaxFixture(t *testing.T, universePath, manifestPath string) (*resolution.ResolutionResult, client.ResolutionClient) {
	t.Helper()
...
func checkRelaxResults(t *testing.T, res []resolution.ResolutionDiff) {
