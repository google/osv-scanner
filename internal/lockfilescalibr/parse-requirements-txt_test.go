...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/empty.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/only-comments.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/one-package-unconstrained.txt")
...
// 			Name:      "flask",
// 			Version:   "0.0.0",
// 			Ecosystem: lockfilescalibr.PipEcosystem,
// 			CompareAs: lockfilescalibr.PipEcosystem,
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/one-package-constrained.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/multiple-packages-constrained.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/multiple-packages-mixed.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/file-format-example.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/with-added-support.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/non-normalized-names.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/with-multiple-r-options.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/with-bad-r-option.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/duplicate-r-dev.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/cyclic-r-self.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/cyclic-r-complex-1.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/with-per-requirement-options.txt")
...
// 	packages, err := lockfilescalibr.ParseRequirementsTxt("fixtures/pip/line-continuation.txt")
