...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/not-pom.txt")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/invalid-syntax.xml")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/empty.xml")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/one-package.xml")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/two-packages.xml")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/with-dependency-management.xml")
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/interpolation.xml")
...
// 	}
// 	type args struct {
// 		lockfile lockfilescalibr.MavenLockFile
// 	}
// 	tests := []struct {
// 		name   string
// 		fields fields
...
// 			args:   args{lockfile: lockfilescalibr.MavenLockFile{}},
// 			want:   "1.0",
// 		},
...
// 			mld := lockfilescalibr.MavenLockDependency{
...
// 	packages, err := lockfilescalibr.ParseMavenLock("fixtures/maven/with-scope.xml")
